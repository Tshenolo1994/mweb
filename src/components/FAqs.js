...
const FAqs = () => {
  return (
   <Box h={{base:'100%', md:"100vh",lg:'100vh'}} m={{base:0,md:15,lg:20}} bg="linear-gradient(360deg, hsla(0, 0%, 75%, 1) 0%, hsla(0, 0%, 75%, 1) 41%, hsla(0, 0%, 98%, 1) 70%, hsla(0, 0%, 98%, 1) 100%)" justifyContent="center" alignItems={'center'} flexDirection="column" pt={20} >

    <Heading textAlign={'center'}  fontSize={{ base: '3xl', md: '4xl', lg: '5xl' }} fontFamily={'Mada'}  fontWeight={400} letterSpacing={2} w="100%">Have any Questions?</Heading>
    <Tabs variant='unstyled' colorScheme='green' h='100%'>
  <TabList  display={'flex'} justifyContent="center" alignItems={'center'} gap={{base:5,md:15,lg:20}} pt={{base:20,md:80,lg:100}} mb={10}  flexDirection={{base:'column', md:"row",lg:'row'}}>
  ...
  <TabPanels pt={50}>
    <TabPanel>
    <Grid templateColumns={{base:'100%',md:'repeat(2, 1fr)',lg:'repeat(2, 1fr)'}} gap={20} h={{base:'100%', md:'100%', lg:'100%'}}>
  <GridItem w='100%' h='100%' bg='transparent'>
  <Accordion defaultIndex={[0]} allowMultiple h="100%">
  <AccordionItem mb={{base:2,md:10,lg:10}} border='none'>
    <h2 bg="transparent" >
      <AccordionButton bg='transparent' fontSize={{ base: '2xl', md: '4xl', lg: 'xl' }}fontFamily={'Mada'} border='none'>
      <Box as="span" flex='1' textAlign='left' pb={{base:0,md:8,lg:10}} bg='transparent' border='none' >
          What is Fibre
        </Box>
        <AccordionIcon />
      </AccordionButton>
    </h2>
    <AccordionPanel pb={4} pt={{base:2,md:8,lg:8}} lineHeight="2rem">
